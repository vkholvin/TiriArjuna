export default function Register(){
    return (
        <div className="bg-ungu w-full h-screen flex items-center justify-center">
            <form className=" bg-putih w-[500px] h-[700px] rounded-3xl">
                <div className="flex-col mb-5 group">
                    <h3 className="font-bold text-3xl text-center p-8">Sign Up</h3>
                </div>
                <div className = "px-8 pb-6">
                    <label for="user_name" class="block mb-2 text-lg font-bold text-gray-900 dark:text-white">Create Username</label>
                ...
                <div className = "px-8 pb-6">
                    <label htmlfor="floating_password" class="block mb-2 text-lg font-bold text-gray-900 dark:text-white">Create a Password</label>
                ...
                <div className = "px-8 pb-6">
                    <label htmlfor="floating_password" class="block mb-2 text-lg font-bold text-gray-900 dark:text-white">Confirm Password</label>
                    <input type="password" name="floating_password" id="floating_password" className="bg-gray-50 border border-gray-300 text-gray-900 text-sm rounded-lg focus:ring-blue-500 focus:border-blue-500 block w-full p-2.5 dark:bg-gray-700 dark:border-gray-600 dark:placeholder-gray-400 dark:text-white dark:focus:ring-blue-500 dark:focus:border-blue-500" placeholder="Input Your Password Again* " required />
                </div>

                <div className = "px-8 pb-6">
                    <label htmlfor="floating_email" class="block mb-2 text-lg font-bold text-gray-900 dark:text-white">Input Email Address</label>
