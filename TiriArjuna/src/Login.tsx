...
export default function Login() {
  return (
      <div className="bg-[url('/assets/bagron.svg')] w-full h-screen flex items-center justify-center">
        <form className=" bg-form w-[500px] h-3/4 rounded-3xl">
      <div className="flex-col mb-5 group pb-4">
        <h3 className="font-bold text-3xl text-center p-8 text-putih">Login</h3>
        <h2 className="px-10 text-xl text-putih">Username</h2>
        <div className="mx-10 flex flex-row  border-0 border-b-2 border-abu appearance-none peer">
          ...
          <input type="text" name="floating_email" id="floating_email" className="text-putih block py-2.5 px-0 w-full text-sm bg-transparent border-0  border-g appearance-none dark:text-white focus:outline-none focus:ring-0 focus:border-blue-600 peer" placeholder="Type your username" required />
